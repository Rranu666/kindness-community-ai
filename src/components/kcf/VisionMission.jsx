...
export default function VisionMission() {
  ...
  return (
    <section id="vision" style={{ background: "#f0f0ef" }} ref={ref}>

      {/* ── VISION HERO ─────────────────────────────────────────────────── */}
      <div className="relative overflow-hidden py-28 lg:py-36" style={{ background: "#ffffff" }}>
        {/* Background glow */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-rose-200 mb-6"
                ...
                <span className="text-rose-500 text-xs font-bold tracking-widest uppercase">Our Vision</span>
              </div>
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-[1.1] mb-6">
              ...
              {/* AI badge */}
              <div className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-gray-50 border border-gray-200">
                <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center">
                  <BrainCircuit className="w-4 h-4 text-white" />
                </div>
                <div>
                  <div className="text-gray-900 text-sm font-semibold">AI-Accelerated Impact</div>
                  <div className="text-gray-400 text-xs">Intelligent systems amplifying human kindness at scale</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                {aiInsights.map((s, i) => (
                  <motion.div
                    ...
                    className="flex items-center gap-3 p-4 rounded-xl bg-white border border-gray-200 hover:border-rose-200 transition-all duration-300"
            ...
            >
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-xl border border-gray-200">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-green-300 text-xs font-semibold">Live Community Impact</span>
                  </div>
              ...
              <motion.div
                ...
                className="hidden sm:block absolute -bottom-6 -right-4 w-36 md:w-44 rounded-2xl overflow-hidden shadow-xl border-2 border-white"
              >
                <img
              ...
              <motion.div
                ...
                className="absolute -top-4 -left-4 bg-white border border-gray-200 rounded-2xl px-4 py-3 shadow-lg"
              >
                <div className="flex items-center gap-2 mb-1">
                  <Sparkles className="w-4 h-4 text-rose-500" />
                  <span className="text-gray-900 text-xs font-bold">Kindness Score</span>
                </div>
                <div className="flex items-end gap-1">
                  <span className="text-2xl font-extrabold text-gray-900">9.8</span>
                  <span className="text-rose-500 text-xs font-semibold mb-1">/ 10</span>
                </div>
          ...
          >
            {visionItems.map((item, i) => (
              <div
                key={i}
                className="flex items-start gap-3 p-4 rounded-2xl bg-white border border-gray-200 hover:border-rose-200 hover:shadow-sm transition-all duration-300 group"
              >
                ...
                <p className="text-gray-500 text-xs font-medium leading-relaxed group-hover:text-gray-700 transition-colors">{item.text}</p>
              </div>
            ))}
          </motion.div>
        </div>
      ...
      {/* ── MISSION ─────────────────────────────────────────────────── */}
      <div className="py-24 lg:py-32" style={{ background: "#f0f0ef" }}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-rose-200 mb-6"
              ...
              <span className="text-rose-500 text-xs font-bold tracking-widest uppercase">Our Mission</span>
            </div>
            ...
            <div className="px-5 py-4 rounded-xl bg-white border-l-4 border-rose-500 shadow-sm">
          ...
          >
            {missionItems.map((item, i) => (
              <div
                key={i}
                className="flex items-center gap-5 p-5 rounded-2xl border border-gray-200 hover:border-rose-200 bg-white transition-all duration-300"
                style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-rose-500 to-pink-500 flex items-center justify-center flex-shrink-0 shadow-md shadow-rose-100">
