...
export default function LeadershipSection() {
  return (
    <section id="leadership" style={{ background: "#030712" }} className="py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <AnimBlock className="text-center mb-14">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-rose-500/20 mb-6"
            ...
            <span className="text-rose-400 text-xs font-bold tracking-widest uppercase">Leadership</span>
          </div>
          ...
          {leaders.map((leader, i) => {
            ...
            return (
              <AnimBlock key={i} delay={0.1 + i * 0.12}>
                <div
                  className="rounded-3xl p-8 border border-white/[0.06] hover:border-rose-500/20 transition-all duration-500 h-full"
                ...
                >
                  ...
                  <h4 className="text-xl font-black text-white mb-3">{leader.name}</h4>
                  <p className="text-sm text-white/45 leading-relaxed">{leader.desc}</p>
                </div>
              </AnimBlock>
            );
          })}
